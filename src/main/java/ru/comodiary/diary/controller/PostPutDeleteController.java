...
public class PostPutDeleteController {
    ...
    public String addNewTask(@RequestParam("title") String title,
        ...
        model.addAttribute("day", service.getAllDayTasks(expireDate));
        model.addAttribute("dayName", service.getDayName(expireDate));
        return "day";
    }
    ...
    public ModelAndView deleteById(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("day", service.getAllDayTasks(task.getExpireDate()));
